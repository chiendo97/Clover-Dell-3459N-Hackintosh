 ...
 *
 * Disassembly of DSDT.aml, Fri Jan 12 02:07:48 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001F2B9 (127673)
 *     Revision         0x02
 *     Checksum         0xE1
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "CBX3   ", 0x01072009)
{
     ...
     * disassembly, but only 20 were resolved (9 unresolved). Additional
    ...
    External (_SB_.PCI0.RP01.PEGP, UnknownObj)    // Warning: Unknown object
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xA8EDF000, 0x0600)
    ...
    OperationRegion (EXBU, SystemMemory, 0xA8EE2000, 0x0012)
    ...
    OperationRegion (OGNV, SystemMemory, 0xA92CE000, 0x0003)
...
If (PM0H)
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xA84C5F18, 0x10)
...
RWAK (Arg0)
    ...
    Scope (_SB.PCI0.I2C0)
    {
        Device (TPD0)
        {
            ...
            CreateWordField (SBFB, \_SB.PCI0.I2C0.TPD0._Y24._ADR, ADRT)  // _ADR: Address
    ...
    Scope (_GPE)
    {
        ...
        Method (_L46, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            If (LEqual (\_SB.GGIV (0x02040006), Zero))
            {
                P8XH (Zero, 0x34)
                P8XH (One, 0x35)
                EV4 (One, Zero)
            ...
            Name (BUF0, ResourceTemplate()
{
    ...
    OperationRegion (ABNV, SystemMemory, 0xA8ECA000, 0x0013)
    ...
    Device (_SB.TPM)
    {
        ...
        Method (_STA, 0, NotSerialized)  // _STA: Status
        {
            ...
            {
                If (LAnd (TPMF, LNotEqual (OSYS, 0x07D9)))
                {
                    Return (0x0F)
                }
    ...
    Scope (_SB.AMW0)
    {
        ...
        Method (_WED, 1, NotSerialized)  // _Wxx: Wake Event
        {
            ...
            ElseIf (And (WMEV, 0x0800))
            {
                ...
                If (LEqual (OSYS, 0x07D9))
                {
                    If (And (LEqual (WMI1, 0x10), LEqual (WMI2, 0x57)))
                    {
                        Store (0x03, WMI0)
                        Store (Zero, WMI1)
                        Store (0xE005, WMI2)
                        Store (GENS (0x09, 0x06, Zero), WMI3)
                    }
                    ElseIf (And (LEqual (WMI1, 0x10), LEqual (WMI2, 0x58)))
                    {
                        Store (0x03, WMI0)
                        Store (Zero, WMI1)
                        Store (0xE006, WMI2)
                    ...
                    ElseIf (And (LEqual (WMI1, 0x10), LEqual (WMI2, 0x3A)))
                    {
                        Store (0x02, WMI0)
                        Store (Zero, WMI1)
                        Store (0x3A, WMI2)
                    }
                    ElseIf (And (LEqual (WMI1, 0x10), LEqual (WMI2, 0x45)))
                    {
                        Store (0x02, WMI0)
                        Store (Zero, WMI1)
                        Store (0xE045, WMI2)
                    }
                    ElseIf (And (LEqual (WMI1, 0x10), LEqual (WMI2, 0xE008)))
                    {
                        Store (0x06, WMI0)
                        Store (Zero, WMI1)
                        Store (GENS (0x2F, Zero, Zero), Local0)
                        Store (And (Local0, 0xFFFF), WMI3)
                        Store (ShiftRight (Local0, 0x10), WMI4)
                        Store (Zero, WMI5)
                        Store (Zero, WMI6)
                    }
                }
                ...
                If (And (LEqual (WMI1, 0x10), LEqual (WMI2, 0x44)))
                {
                    ...
                    ElseIf (LEqual (WMI5, 0x02EB))
                    {
                        Store (Or (And (CMA0, 0xC0), One), CMA0)
                        Store (0x03, WMI0)
                        Store (Zero, WMI1)
                        Store (0xE00C, WMI2)
                        Store (0x02, WMI3)
                    ...
                    ElseIf (LEqual (WMI5, 0x02F6))
                    {
                        Store (Or (And (CMA0, 0xC0), 0x02), CMA0)
                        Store (0x03, WMI0)
                        Store (Zero, WMI1)
                        Store (0xE00C, WMI2)
                        Store (0x03, WMI3)
                ...
                If (And (LEqual (WMI1, 0x11), LEqual (WMI2, 0xE070)))
                {
                    Store (0x03, WMI0)
                    Store (Zero, WMI1)
                }
    ...
    Method (NEVT, 0, NotSerialized)
    {
        ...
        If (And (Local0, 0x8000))
        {
            ...
            {
                Notify (\_SB.PCI0.RP01.PEGP, 0xD5)
            }
            Else
            {
                Notify (\_SB.PCI0.RP01.PEGP, 0xD0)
                EV10 (0x8000, Local1)
            }
        }
    ...
    Scope (_SB.PCI0.LPCB)
    {
        Device (PS2K)
        {
            Name (_HID, "DLLK06B1")  // _HID: Hardware ID
        ...
        Device (PS2M)
        {
            Name (_HID, EisaId ("SYN0609"))  // _HID: Hardware ID
